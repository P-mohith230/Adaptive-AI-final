...
const FinanceControlCenterPage = lazy(() => import('@/pages/finance-control-center'))
const ReconciliationPage = lazy(() => import('@/pages/reconciliation'))
const MerchantLedgerPage = lazy(() => import('@/pages/merchant-ledger'))
          ...
          <AuthProvider>
            ...
            <Suspense fallback={<LoadingFallback />}>
              <Routes>
                ...
                >
                  <Route path="/" element={<FinanceControlCenterPage />} />
                  <Route path="/control-center" element={<FinanceControlCenterPage />} />
                  <Route path="/reconciliation" element={<ReconciliationPage />} />
                  <Route path="/merchant-ledger" element={<MerchantLedgerPage />} />
