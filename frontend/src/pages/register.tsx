  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-2">
      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4 py-10">
        <Card className="w-full max-w-[420px] border-border/60 shadow-lg bg-card">
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col items-center pt-8 pb-3 px-8 text-center">
              <div className="mb-4 lg:hidden">
                <AdaptiveLogo size={36} />
              </div>
              <h1 className="text-xl font-bold tracking-tight text-foreground">{t('auth.register')}</h1>
              <p className="text-xs text-muted-foreground mt-1.5">{t('auth.registerDescription')}</p>
            </div>
